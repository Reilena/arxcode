...
class CmdCalendar(ArxPlayerCommand):
    ...
    def do_form_switches(self):
        ...
        if "abort" in self.switches:
            ...
            self.msg(self.form.display(self.caller.timezone), options={'box': True})
    ...
    def display_project(self):
        ...
        if not form:
            ...
            msg += form.display(self.caller.timezone)
...
class CmdPrayer(ArxPlayerCommand):
    ...
    def valid_god_choices(self):
        """Defines the Gods you can pray to."""
        return Character.objects.filter(Q(roster__roster__name="Gods"))
    ...
    def func(self):
        ...
        if 'offer' in self.switches:
            try:
                ...
                return self.msg("No God found named %s" % lhs)
            else:
                if not targ:
                    return
                if not targ:
                    caller.msg("No God found named %s" % lhs)
                    return
                jname = "prayer"
